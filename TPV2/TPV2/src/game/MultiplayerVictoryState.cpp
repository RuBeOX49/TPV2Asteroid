#include "MultiplayerVictoryState.h"
...
MultiplayerVictoryState::MultiplayerVictoryState()
{
	TextTexture1 = new Texture(SDLUtils::instance()->renderer(), "Has ganado!", *(Game::instance()->getGameFont()), build_sdlcolor("0x2020ffff"));
